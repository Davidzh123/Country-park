...
$codes = array(
    ...
    405 => array('405 Method Not Allowed',
        'The method specified in the request is not allowed for the specified resource.'
    ),
    ...
    500 => array('500 Internal Server Error',
        'The request was unsuccessful due to an unexpected condition encountered by' .
        ' the server.'),
    ...
    504 => array('504 Gateway Timeout',
        'The upstream server failed to send a request in the time allowed by the' .
        ' server.'),
);
if($_SERVER['PATH_INFO']!=$_SERVER['PATH_TRANSLATED']){
